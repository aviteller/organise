<script>
  ...
  const changeSize = () => document.execCommand("fontSize", false, fontSize);
  const changeColour = () =>
...
<div id="container">
  <!-- <fieldset>
    <button class="fontStyle bold " on:click={() => format('bold')}>b</button>
    <button class="fontStyle italic" on:click={() => format('italic')}>
      i
    </button>
    <button on:click={() => format('insertunorderedlist')}>ol</button>
    <button class="fontStyle underline" on:click={() => format('underline')}>
      _
    </button>
    <button on:click={setUrl}>link</button> -->
  <fieldset>
    <button
    ...
    <button class="fontStyle underline" on:click={() => format('underline')} />
    <button class="fontStyle" on:click={() => format('removeFormat')}>
      RM
    </button>
    <select
      id="input-font"
    ...
    <button
      ...
      on:click={() => format('strikethrough')}>
      <strikethrough />
    </button>
    <button class="fontStyle align-left" on:click={() => format('justifyLeft')}>
      <justifyLeft />
    </button>
    <button
    ...
    <button class="fontStyle redo-apply" on:click={() => format('redo')}>
      <redo />
    </button>
    <button class="fontStyle undo-apply" on:click={() => format('undo')}>
      <undo />
    </button>
    <button
    ...
    <input
      ...
      class="color-apply"
      type="color"
      on:blur={changeColour}
      id="myColor" />

    <!-- font size start -->
    <select id="fontSize" bind:value={fontSize} on:change={changeSize}>
